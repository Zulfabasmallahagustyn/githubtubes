...
class DetailUserViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun  addToFavorite (username: String, id: IntArray?, avatarUrl: String){
    ...
    suspend fun checkUser(id: IntArray?) = userDao?.checkUser(id)

    fun  removeFromFavorite(id: IntArray?){
        CoroutineScope(Dispatchers.IO).launch {
